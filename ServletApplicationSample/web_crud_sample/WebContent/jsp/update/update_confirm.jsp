...
<body>
  ...
  <div id="contents">
    ...
    <table align="center" width="300px">
      ...
      <tr>
        <th>氏 名</th>
        <td><c:out value="${updateForm.empName}" /></td>
      </tr>
      <tr>
        <th>性 別</th>
      ...
      <tr>
        <th>住 所</th>
        <td><c:out value="${updateForm.address}" /></td>
      </tr>
      <tr>
        <th>生年月日</th>
        <td><c:out value="${updateForm.birthday}" /></td>
      </tr>
      <tr>
        <th>権 限</th>
      ...
      <tr>
        <th>部署名</th>
        <td><c:out value="${updateForm.deptName}" /></td>
      </tr>
    </table>
    <form method="post"
      ...
      <input type="hidden" name="empId" value="${updateForm.empId}" /> <input
        ...
        type="hidden" name="authority" value="${updateForm.authority}" /> <input
        type="hidden" name="deptId" value="${updateForm.deptId}" /> <input
